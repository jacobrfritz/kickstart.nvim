...
require('lazy').setup({
  ...
  --'tpope/vim-rhubarb',
  {
    'mbbill/undotree',
    config = function()
      -- Optional: Set a keymap to toggle the Undotree panel
  ...
  },
  {
    ...
    opts = {
      condition = function(buf)
        local fn = vim.fn
        -- List of filetypes you DON'T want to auto-save
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          mappings = {
            -- "i" is for Insert mode (when you are typing to search)
            i = {
              ['<C-s>'] = 'select_vertical', -- Use Ctrl+s since Ctrl+v is broken for you
              ['<C-h>'] = 'select_horizontal', -- Use Ctrl+h for horizontal split
            },
            -- "n" is for Normal mode (after you press Esc)
            n = {
              ['v'] = 'select_vertical', -- Now pressing 'v' will split vertically!
              ['s'] = 'select_horizontal', -- Now pressing 's' will split horizontally
            },
          },
        },
        extensions = {
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    -- Remove the 'main = ...' line if it exists
    config = function()
      -- Try 'nvim-treesitter.configs' first; if it still fails, use 'nvim-treesitter'
      ...
      treesitter.setup {
        ...
        highlight = {
          enable = true,
          -- Some languages depend on vim's regex highlighting (like Ruby)
